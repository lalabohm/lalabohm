...
- **Linguagens:** C, Typescript, x86-64 Assembly, Python, SQL.
- **Segurança:** Burp Suite, SQLMap, Netcat, Metasploit.
- **Sistemas:** Linux (Ubuntu/WSL), Gestão de Memória, Kernel Basics.
